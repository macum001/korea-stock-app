...
// jp: 지분변동은 합병분할보다 먼저 (소유주식'변동'이 최대주주'변경'보다 우선 매칭되도록 키워드 분리).
const CATEGORY_TYPE_RULES = [
  ...
  // ── 지분변동 (소유·보유 보고서류 — 합병분할보다 먼저)
  { keywords: ['특정증권등소유상황', '주요주주특정증권', '임원·주요주주', '임원ㆍ주요주주'], type: '지분변동' },
  { keywords: ['대량보유상황'], type: '지분변동' },
  { keywords: ['최대주주등소유주식변동', '소유주식변동', '대주주소유주식'], type: '지분변동' },
  { keywords: ['특수관계인출자', '특수관계인에대한출자', '특수관계인과의내부거래'], type: '지분변동' },
  ...
  { keywords: ['타법인주식', '출자증권취득', '타법인증권취득'], type: '합병분할' },
  ...
  { keywords: ['전환가액의조정', '전환가액조정', '행사가액조정'], type: '증자감자' },
  { keywords: ['감자', '자본감소'], type: '증자감자' },
  { keywords: ['주식분할', '주식병합', '액면분할', '액면병합'], type: '증자감자' },
  { keywords: ['주식소각', '이익소각', '자기주식소각', '자사주소각'], type: '증자감자' },
  { keywords: ['주식매수선택권', '스톡옵션'], type: '증자감자' },
  { keywords: ['증권발행실적', '증권발행결과'], type: '증자감자' },
  { keywords: ['투자설명서', '증권신고서', '일괄신고'], type: '증자감자' },

  // ── 실적·재무
  { keywords: ['매출액또는손익구조', '매출액변동', '손익구조변동', '매출액·손익구조'], type: '실적재무' },
  { keywords: ['잠정실적', '영업실적', '연간실적', '반기실적', '분기실적', '결산실적'], type: '실적재무' },
  { keywords: ['자본잠식'], type: '실적재무' },
  { keywords: ['채무보증', '채무인수', '담보제공'], type: '실적재무' },
  { keywords: ['단기차입금', '장기차입금', '차입금증가', '금전대여'], type: '실적재무' },
  ...
  { keywords: ['투자판단관련주요경영사항', '투자판단'], type: '계약소송' },
  { keywords: ['신규시설투자', '유형자산취득', '유형자산처분', '토지취득', '건물취득'], type: '계약소송' },

  // ── 배당·주총
  { keywords: ['현금배당', '주식배당', '중간배당', '결산배당', '배당결정'], type: '배당주총' },
  { keywords: ['의결권대리행사권유', '의결권대리행사'], type: '배당주총' },
...
const CATEGORY_TYPE_RULES_N = (CATEGORY_TYPE_RULES as { keywords: string[]; type: DisclosureCategoryType }[]).map((r) => ({
  type: r.type,
